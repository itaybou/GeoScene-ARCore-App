package com.geoscene.places.overpass.queries.query;

import java.util.Locale;

import com.geoscene.places.overpass.queries.output.OutputFormat;
...
import static com.geoscene.places.overpass.queries.output.OutputModificator.*;
import static com.geoscene.places.overpass.queries.output.OutputOrder.*;
import static com.geoscene.places.overpass.queries.output.OutputVerbosity.*;
...
public class OverpassQuery extends AbstractOverpassQuery {
    ...
    public OverpassQuery output(OutputVerbosity verbosity, OutputModificator modificator, OutputOrder order) {
        builder.append(String.format("; out %s %s %s",
                verbosity.toString().toLowerCase(),
                modificator.toString().toLowerCase(),
                order.toString().toLowerCase())
        );
