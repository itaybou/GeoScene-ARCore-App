import { String, Type } from 'valib';

import invariant from 'invariant';

const notEmpty = (str) =>
  (Type.isString(str) && !String.isEmpty(str)) || 'cannot be empty';
...
const withDefaultValidations = (validations) =>
  Object.assign(
    {},
    {
...
const validate = (customValidations = {}) => (props) => {
  ...
  return Object.keys(props).map((property) =>
    isValid(property, props[property], validations[property]),
  );
};
