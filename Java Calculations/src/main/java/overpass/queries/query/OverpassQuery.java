package overpass.queries.query;

import java.util.Locale;

import overpass.queries.output.OutputFormat;
...
import static overpass.queries.output.OutputModificator.*;
import static overpass.queries.output.OutputOrder.*;
import static overpass.queries.output.OutputVerbosity.*;
